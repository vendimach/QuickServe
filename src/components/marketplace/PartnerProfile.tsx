...
export const PartnerProfile = ({ partnerId }: Props) => {
  ...
  const { reviewsForPro } = useMarketplaceData();
    ...
    <div className="px-5 pb-6">
      ...
      <div className="rounded-3xl bg-card p-5 shadow-card">
        <div className="flex items-center gap-4">
          <div className="flex h-16 w-16 items-center justify-center rounded-full gradient-primary text-lg font-bold text-primary-foreground shadow-soft">
            {pro.avatar}
          </div>
        ...
        <div className="mt-3 inline-flex items-center gap-1 rounded-full bg-success/15 px-2 py-1 text-[11px] font-bold text-success">
